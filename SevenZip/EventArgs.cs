...
namespace SevenZip
{
    ...
    public sealed class CompressionErrorEventArgs : EventArgs
    {
        ...
        public CompressionErrorEventArgs(CompressionErrorBehavior defaultAction, CompressionErrorType errorType, string sourceFile, string archiveFile, Exception ex)
        {
